...
#        mu_size = 2
        ...
        point_mesh = np.mgrid[size-size:size:space,size-size:size:space]
        ...
        point_mesh = np.mgrid[mu_size-mu_size:mu_size:mu_space,mu_size-mu_size:mu_size:mu_space]
        ...
        if best_error:
            ...
            for row in np.linspace(0+.3, size-.3, 10):
                for col in np.linspace(0+.3, size-.3, 10):
